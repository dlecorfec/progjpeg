...
func TestIssue78368(t *testing.T) {
...
func TestDecodeFlexSubsampling(t *testing.T) {
	testCases := []struct {
		...
		{"2x2,1x1,2x2", "testdata/video-001.q50.221122.jpeg"},
		{"2x1,1x2,1x1", "testdata/video-001.q50.211211.jpeg"},
		{"2x2,2x1,1x2", "testdata/video-001.q50.222112.jpeg"},
		{"1x2,1x1,2x1", "testdata/video-001.q50.121121.jpeg"},
	}
	for _, tc := range testCases {
